...
import com.example.pack_easy.CheckList;
...
//                Toast.makeText(activity, "Clicked", Toast.LENGTH_SHORT).show();
                ...
                intent.putExtra(MyConstants.HEADER_SMALL,title.get(position));
                if(MyConstants.MY_SELECTIONS.equals(title.get(position))) {
